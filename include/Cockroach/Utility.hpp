...
namespace Cockroach
{
	...
	inline float computePCResolution(std::shared_ptr <open3d::geometry::PointCloud> cloud)
	{
	...
	inline std::shared_ptr<open3d::geometry::PointCloud> voxelDownSampling(std::shared_ptr<open3d::geometry::PointCloud> cloud, float VoxelSize)
	{
	...
	inline std::shared_ptr<open3d::geometry::PointCloud> uniformDownsample(std::shared_ptr<open3d::geometry::PointCloud> cloud, int targetOfPoints)
	{
		using namespace std;
	...
	inline std::shared_ptr<open3d::geometry::PointCloud> statisticalOutlierRemoval(std::shared_ptr<open3d::geometry::PointCloud> cloud, int nbNeighbors = 20, double stdRatio = 2.0)
	{
	...
	inline std::shared_ptr<open3d::geometry::PointCloud> importCloud(std::string FILE_NAME_)
	{
	...
	inline std::shared_ptr<open3d::geometry::OrientedBoundingBox> computeOrientedBoundingBox(std::shared_ptr<open3d::geometry::PointCloud> cloud)
	{
	...
	inline double computeThreshold(std::shared_ptr<PC> cloudSource, std::shared_ptr<PC> cloudTarget)
	{
	...
	inline void estimateUnstructuredPCDNormals(std::shared_ptr<open3d::geometry::PointCloud> cloud,
		int numberOfCPUser,
	...
	/// <returns></returns>
	inline std::shared_ptr<open3d::geometry::PointCloud> substractCloud(std::shared_ptr<open3d::geometry::PointCloud> cloud_one,
